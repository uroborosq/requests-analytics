...
class Request(object):
    ...
    def __init__(self, begin_, begin_working_, end_, id_, status_, manager_, engineer_, warranty_, request_state_, client_,
                 address_, model_):
    ...
    def get(self):
        return [self.date_begin, self.date_end, self.id, self.phase, self.warranty, self.status,
                self.manager, self.client, self.begin_working, self.engineer, self.address, self.model]
